...
/**
 * The {@link FailsafeElement} class holds the current value and original value of a record within a pipeline. This
 * class allows pipelines to not lose valuable information about an incoming record throughout the processing of that
 * record. The use of this class allows for more robust dead-letter strategies as the original record information is not
 * lost throughout the pipeline and can be output to a dead-letter in the event of a failure during one of the pipelines
 * transforms.
 */
