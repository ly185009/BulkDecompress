...
public abstract class JavascriptTextTransformer {
    ...
    /**
     * Retrieves a {@link JavascriptRuntime} configured to invoke the specified function within the script. If either
     * the fileSystemPath or functionName is null or empty, this method will return null indicating that a runtime was
     * unable to be created within the given parameters.
     *
    ...
    /**
     * Grabs code from a FileSystem, loads it into the Nashorn Javascript Engine, and executes Javascript Functions.
     */
    @AutoValue
    public abstract static class JavascriptRuntime {
         ...
         * The logger to output status messages to.
         */
        private static final Logger LOG = LoggerFactory.getLogger(JavascriptRuntime.class);
        ...
        /**
         * Factory method for generating a com.ncr.nr1.centralreports.JavascriptTextTransformer.Builder.
         *
         * @return a com.ncr.nr1.centralreports.JavascriptTextTransformer builder
         */
        ...
        /**
         * Loads into memory scripts from a File System from a given path. Supports any file system that {@link
         * FileSystems} supports.
         *
        ...
        private static Collection<String> getScripts(String path) throws IOException {
            ...
            checkArgument(
                    result.status() == Status.OK && !result
                            .metadata()
                            .isEmpty(),
    ...
    public abstract static class TransformTextViaJavascript
         ...
         * The logger to output status messages to.
         */
        private static final Logger LOG = LoggerFactory.getLogger(TransformTextViaJavascript.class);
    ...
    /**
     * The {@link FailsafeJavascriptUdf} class processes user-defined functions is a fail-safe manner by maintaining the
     * original payload post-transformation and outputting to a dead-letter on failure.
     */
    @AutoValue
    public abstract static class FailsafeJavascriptUdf<T>
        ...
        public PCollectionTuple expand(PCollection<FailsafeElement<T, String>> elements) {
            return elements.apply(
                    ...
                    ParDo
                            .of(
                                    new DoFn<FailsafeElement<T, String>,
                                            FailsafeElement<T, String>>() {
                                        private JavascriptRuntime javascriptRuntime;
                                        ...
                                        public void processElement(ProcessContext context) {
                                            FailsafeElement<T, String> element =
                                                    context.element();
