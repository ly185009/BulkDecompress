 ...
 * href="https://issues.apache.org/jira/browse/AVRO-1571">AVRO-1571</a>) without requiring to explicitly specifying the
 * schema for the type.
 *
...
public class FailsafeElementCoder<OriginalT, CurrentT>
    ...
    public void encode(FailsafeElement<OriginalT, CurrentT> value, OutputStream outStream)
            throws IOException {
        if (value == null) {
            throw new CoderException("The com.ncr.nr1.centralreports.FailsafeElementCoder cannot encode a null "
                    + "object!");
        }
    ...
    @Override
    public FailsafeElement<OriginalT, CurrentT> decode(InputStream inStream)
            throws IOException {
        ...
        return FailsafeElement
                .of(originalPayload, currentPayload)
